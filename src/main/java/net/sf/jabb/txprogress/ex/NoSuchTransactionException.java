...
/**
 * The exception happens in the situation that the specified transaction cannot be found.
 * @author James Hu
 *
 */
public class NoSuchTransactionException extends TransactionalProgressException {
     ...
     *                           be writable
     */
    protected NoSuchTransactionException(String message, Throwable cause,

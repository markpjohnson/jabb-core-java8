 ...
 *  <li>They have to be unique within a reasonable time period across all series. That means usually transaction IDs are just UUIDs</li>
 *  <li>Some of the methods accepts both seriesId and transactionId, some accepts transactionId along or allow seriesId to be null. 
 *  	Whenever possible, try to use the version with both seriesId and transactionId because the implementation may be more efficient in this case.</li>
 * </ul>
 * 
...
public interface SequentialTransactionsCoordinator {
	 ...
	 * @param seriesId			ID of the transaction series, can be null because transactionId is already an unique identifier.
	 * @param processorId			ID of the processor which must currently own the transaction
	 ...
	 * 										no immediate retry should be attempted.
	 */
	default void finishTransaction(String processorId, String transactionId)
			throws NotOwningTransactionException, TransactionStorageInfrastructureException, IllegalTransactionStateException, NoSuchTransactionException, IllegalEndPositionException{
		finishTransaction(null, processorId, transactionId, null);
	}
	 ...
	 * 										no immediate retry should be attempted.
	 */
	default void abortTransaction(String processorId, String transactionId) 
			throws NotOwningTransactionException, TransactionStorageInfrastructureException, IllegalTransactionStateException, NoSuchTransactionException{
		abortTransaction(null, processorId, transactionId);
	}
	 ...
	 * @throws IllegalEndPositionException 	if the updated end position creates gap between this and the next transaction.
	 */
	default void updateTransaction(String processorId, String transactionId, String endPosition, Instant timeout, Serializable detail) 
			throws NotOwningTransactionException, TransactionStorageInfrastructureException, IllegalTransactionStateException, NoSuchTransactionException, IllegalEndPositionException{
		updateTransaction(null, processorId, transactionId, endPosition, timeout, detail);
	}
	 ...
	 * @throws IllegalEndPositionException 	if the updated end position creates gap between this and the next transaction.
	 */
	default void updateTransaction(String processorId, String transactionId, String endPosition, Duration timeoutDuration, Serializable detail) 
			throws NotOwningTransactionException, TransactionStorageInfrastructureException, IllegalTransactionStateException, NoSuchTransactionException, IllegalEndPositionException{
		updateTransaction(null, processorId, transactionId, endPosition, timeoutDuration == null ? null : Instant.now().plus(timeoutDuration), detail);
	}
	 ...
	 * @throws IllegalEndPositionException 	if the updated end position creates gap between this and the next transaction.
	 */
	default void updateTransactionEndPosition(String processorId, String transactionId, String endPosition) 
			throws NotOwningTransactionException, TransactionStorageInfrastructureException, IllegalTransactionStateException, NoSuchTransactionException, IllegalEndPositionException{
		Validate.notNull(endPosition, "end position cannot be null");
		updateTransaction(null, processorId, transactionId, endPosition, (Instant)null, null);
	}
	 ...
	 * 										no immediate retry should be attempted.
	 */
	default void renewTransactionTimeout(String processorId, String transactionId, Instant timeout) 
			throws NotOwningTransactionException, TransactionStorageInfrastructureException, IllegalTransactionStateException, NoSuchTransactionException{
		Validate.notNull(timeout, "Transaction time out cannot be null");
		try {
			updateTransaction(null, processorId, transactionId, null, timeout, null);
		} catch (IllegalEndPositionException e) {
			throw Throwables.propagate(e); // should never reach here
		} 
	}
	 ...
	 * 										no immediate retry should be attempted.
	 */
	default void renewTransactionTimeout(String processorId, String transactionId, Duration timeoutDuration) 
			throws NotOwningTransactionException, TransactionStorageInfrastructureException, IllegalTransactionStateException, NoSuchTransactionException{
		Validate.notNull(timeoutDuration, "Transaction time out duration cannot be null");
		renewTransactionTimeout(null, processorId, transactionId, Instant.now().plus(timeoutDuration));
	}
	 ...
	 * 										no immediate retry should be attempted.
	 */
	boolean isTransactionSuccessful(String seriesId, String transactionId) throws TransactionStorageInfrastructureException;
	 ...
	 * 										no immediate retry should be attempted.
	 */
	default boolean isTransactionSuccessful(String transactionId) throws TransactionStorageInfrastructureException{
		return isTransactionSuccessful(null, transactionId);
	}
